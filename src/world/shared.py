...
def get_shared_gable_mesh() -> Mesh:
    ...
    if _shared_gable_mesh is None:
        verts = np.array([
            # Água esquerda (retângulo completo: 2 triângulos)
            -0.5, 0, -0.5, 0, 0,  -0.82, 0.57, 0,   0, 1, -0.5, 1, 0,  -0.82, 0.57, 0,   0, 1, 0.5, 1, 1,  -0.82, 0.57, 0,
            -0.5, 0, -0.5, 0, 0,  -0.82, 0.57, 0,   0, 1, 0.5, 1, 1,  -0.82, 0.57, 0,  -0.5, 0, 0.5, 0, 1,  -0.82, 0.57, 0,
            # Água direita (retângulo completo: 2 triângulos)
             0.5, 0, -0.5, 0, 0,   0.82, 0.57, 0,   0.5, 0, 0.5, 1, 0,   0.82, 0.57, 0,   0, 1, 0.5, 1, 1,   0.82, 0.57, 0,
             0.5, 0, -0.5, 0, 0,   0.82, 0.57, 0,   0, 1, 0.5, 1, 1,   0.82, 0.57, 0,   0, 1, -0.5, 0, 1,   0.82, 0.57, 0,
